            ...
            <div class="row photo-text">
                ...
                <div class="col-md-6 order-md-1">
                    <div class="content">
                        ...
                        <p>Deléitate con nuestra tarta de chocolate, una experiencia rica y envolvente. Preparada con el
                            mejor cacao, esta tarta ofrece una textura suave y un sabor profundo que encanta a los
                            amantes del chocolate. Perfecta para cualquier ocasión, ¡no podrás resistirte a una segunda
                            porción!</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row photo-text">
                ...
                <div class="col-md-6 order-md-2">
                    <div class="content">
                        ...
                        <p>Si eres fan de los sabores más suaves, nuestra tarta de chocolate con leche es la elección
                            ideal. Con una base esponjosa y una capa cremosa de chocolate con leche, esta tarta es un
                            verdadero placer para el paladar. Su suavidad y dulzura la convierten en una opción
                            irresistible para todos.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row photo-text">
                ...
                <div class="col-md-6 order-md-1">
                    <div class="content">
                        ...
                        <p>La tarta de Lotus es un homenaje a la deliciosa galleta especiada que todos conocemos. Con un
                            toque sutil de caramelo y un sabor único que combina perfectamente con la crema suave de la
                            tarta, esta creación es perfecta para quienes buscan algo diferente. ¡Un bocado de pura
                            indulgencia!</p>
                    </div>
                </div>
            </div>
